              ...
              <div className="w-96 bg-black/60 backdrop-blur-3xl border-r border-white/10 flex flex-col z-30">
                <div className="p-6">
                  <Button
                    ...
                    className="mb-4 text-zinc-400 hover:text-white font-bold"
                  >
              ...
              {FEATURES.map((feature) => {
                return (
                  <button
                    ...
                    className="w-full min-h-[160px] bg-black/30 backdrop-blur-xl border border-white/10 p-10 rounded-[2.5rem] flex items-center gap-10 hover:bg-white/5 hover:border-white/20 transition-all duration-300 group shadow-2xl"
                  >
                    ...
                    <div className="text-left flex-1">
                      <h3 className="text-3xl font-black tracking-tight mb-2 bg-gradient-to-r from-white via-blue-100 to-purple-200 bg-clip-text text-transparent">
                        {feature.title}
                      </h3>
          ...
          <div className="fixed bottom-0 left-0 right-0 h-32 bg-black/80 backdrop-blur-2xl border-t border-white/10 p-4 z-50">
            <div className="max-w-7xl mx-auto h-full flex items-center justify-center gap-3">
              <div className="flex items-center justify-center gap-3 w-full overflow-x-auto no-scrollbar">
                {FEATURES.filter((f) => f.id !== selectedFeature).map(
                  (feature) => {
                    return (
                      <button
                        key={feature.id}
